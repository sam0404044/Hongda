...
const navItems = [
  ...
  { href: "/instructors", label: "師資介紹" },
  { href: "/news", label: "最新文章" },
  { href: "/testimonials", label: "學員回饋" },
];
    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex h-16 items-center justify-between gap-4">
          <Link href="/" className="flex min-w-0 items-center" aria-label="宏達補習班首頁">
            <Image
          ...
          <nav className="hidden items-center gap-6 text-base md:flex">
            ...
            <form action="/search" method="get" className="hidden items-center xl:inline-flex">
              <input
                ...
                name="q"
                placeholder="搜尋課程或文章"
                className="w-40 rounded-l border border-gray-300 px-2 py-1.5 text-sm focus:border-primary focus:outline-none"
              />
              <button
                type="submit"
